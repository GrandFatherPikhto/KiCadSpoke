...
├── test_templates_file.py            # templates_file / template_files merging
...
| `test_templates_file.py` | `templates_file` / `template_files` merging: single file, multiple files, inline+external combination, duplicate detection, missing file handling. |
